...
// import SystemPermissionGate from "../permissions_gates/system_permission_gate/system_permission_gate";
...
class CreatePost extends React.PureComponent {
    ...
    render() {
        ...
        if(currentChannel.name !== "radar") {
            if(currentChannel.name === "insights" || currentChannel.name === "analise"){
                return (
            ...
            if(currentChannel.name === "regras"){
                return (
                    <SystemPermissionGate permissions={[Permissions.USER_RULES_EDITOR]}>
                        <form
                            id='create_post'
                            ref={this.topDiv}
                            className={centerClass}
            ...
            if(currentChannel.name === "melhorias"){
                return (
                    <SystemPermissionGate permissions={[Permissions.USER_RULES_EDITOR]}>
                        <form
                            id='create_post'
            ...
            return(
                <div>
                    <button
                        ...
                        style={{width: "100%"}}
                        className={'AdminButtonOutline btn btn-primary-agf'}
                    >
